...
By using Human Layer, you agree to these terms. If you don't agree, please don't use the service.

## The Service

Human Layer is an AI-powered service that helps you interact with artificial intelligence in a more personalized way. The service is provided "as is" and may change over time as we improve it.
...
- Attempt to reverse engineer or extract the underlying technology.
...
- You are responsible for the content you input and how you use the service's outputs.

## Intellectual Property

The service, including its design, features, and underlying technology, is owned by Human Layer. You may not copy, modify, or distribute any part of the service without permission.
...
- You agree to attempt to resolve disputes informally before filing a claim.
...
*We've tried to keep these terms readable and fair. We're building something we're proud of, and we want you to feel good about using it.*
